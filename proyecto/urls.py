...
urlpatterns = [
    ...
    path('prog/perfil-registrado/<int:id_equipo>/', views.ver_perfil_registrado_otros, name='ver_perfil_registrado_otros'),
    path('prog/proyecto-registrado/<int:id_equipo>/', views.ver_proyecto_grado_otros, name='ver_proyecto_grado_otros'),
    path('prog/tribunal-registrado/<int:id_equipo>/', views.ver_proyecto_tribunal_otros, name='ver_proyecto_tribunal_otros'),
